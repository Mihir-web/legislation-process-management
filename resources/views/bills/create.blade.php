            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="p-lg-5 p-4">
                        ...
                        <form class="user" id="billCreate" method="POST" enctype="multipart/form-data" action="{{ route('billStore') }}">
                        @csrf
...
{!! JsValidator::formRequest('App\Http\Requests\AddBillRequest','#billCreate') !!}
